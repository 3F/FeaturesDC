...
${OBJECTDIR}/_ext/1002511561/GeoIP.o: ../../../geoip/GeoIP.c 
	...
	${RM} $@.d
	$(COMPILE.c) -DBOOST_ALL_NO_LIB -DBOOST_USE_WINDOWS_H -DCASESENSITIVITYDEFAULT_YES -DGEOIPDATADIR=\"../../../geoip\" -DHAVE_STDINT_H=1 -DNDEBUG -DNOMINMAX -DNO_VIZ -DPACKAGE_VERSION=0 -DSTRICT -DUNICODE -DWIN32_LEAN_AND_MEAN -DWINVER=0x502 -DZLIB_WINAPI -D_REENTRANT -D_UNICODE -D_WIN32_IE=0x600 -D_WIN32_WINNT=0x502 -I../../../ -I../../../mingw/preload -I../../../mingw/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1002511561/GeoIP.o ../../../geoip/GeoIP.c
