...
# CC Compiler Flags
CCFLAGS=-std=gnu++11 -pipe -march=i686 -mtune=generic -mthreads -mwindows -O3 -fno-ipa-cp-clone -g -Wall -Wextra -Wno-unused-local-typedefs -Wno-unused-parameter -Wno-unused-value -Wno-missing-field-initializers -Wno-address -Wno-unknown-pragmas -Wno-format -fexceptions
CXXFLAGS=-std=gnu++11 -pipe -march=i686 -mtune=generic -mthreads -mwindows -O3 -fno-ipa-cp-clone -g -Wall -Wextra -Wno-unused-local-typedefs -Wno-unused-parameter -Wno-unused-value -Wno-missing-field-initializers -Wno-address -Wno-unknown-pragmas -Wno-format -fexceptions
...
# Subprojects
.build-subprojects:
	cd ../dcpp && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic
	cd ../dwarf && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic
	cd ../zlib && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic
	cd ../boost && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic
	cd ../bzip2 && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic
	cd ../geoip && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic
	cd ../miniupnpc && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic
	cd ../natpmp && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic
	cd ../dwt && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic
	cd ../intl && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic
...
# Subprojects
.clean-subprojects:
	cd ../dcpp && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic clean
	cd ../dwarf && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic clean
	cd ../zlib && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic clean
	cd ../boost && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic clean
	cd ../bzip2 && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic clean
	cd ../geoip && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic clean
	cd ../miniupnpc && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic clean
	cd ../natpmp && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic clean
	cd ../dwt && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic clean
	cd ../intl && ${MAKE}  -f Makefile CONF=Release_x32_-_i686_generic clean
